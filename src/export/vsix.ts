...
export function buildVsix(doc: ThemeDoc, publisher = 'theme-forge'): { filename: string; data: Uint8Array } {
  ...
  const manifest = {
    ...
    description: `${doc.name} — a color theme built with Theme Forge`,
    version,
    publisher,
...
[Theme Forge](https://github.com/camhardy/vs-theme-builder).
